...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=00D4FF&center=true&vCenter=true&width=600&lines=Building+the+future+with+AI+%F0%9F%A4%96;BS+Artificial+Intelligence+%40+FAST;C%2B%2B+%7C+Python+%7C+Machine+Learning;Turning+data+into+intelligence+%E2%9C%A8)](https://git.io/typing-svg)
...
College  : FAST - National University of Computing and Emerging Sciences
Degree   : BS Artificial Intelligence
Location : Faisalabad, Pakistan 🇵🇰
Languages: [Python, C++ , React, Nodejs , Java , R]
...
|---|---|---|
| [💓 Heart Disease Prediction](https://github.com/SadfTahir/Heart_Disease_Prediction) | ML model to predict heart disease risk from patient data | Python, Jupyter |
| [🌳 ID3-ML](https://github.com/SadfTahir/ID3-ML) | Implementation of the ID3 Decision Tree algorithm from scratch | Python |
| [🏠 RPLAN-Toolbox](https://github.com/SadfTahir/RPLAN-Toolbox) | Toolbox for working with RPLAN floor plan dataset | Python |
| [👩‍💻 Git Demo](https://github.com/SadfTahir/git-demo) | Beginner-friendly Git & GitHub practice project | Git |
